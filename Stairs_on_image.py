...
try:
    ...
    if lines in lines is not None:
        ...
        for line in lines:
            ...
            for x1, y1, x2, y2 in line:
                ...
                # checking for parallel lines 1000000
                if (y2 - y1) / (x2 - x1) in np.linspace(0, 0.5, 100):
    ...
    if (c != 1) and (i >= 4):
        ...
        fontScale = 0.5
        thickness = 1
        cv2.putText(image, 'Stairs', org, font,
                    fontScale, (0, 0, 255), thickness)
        cv2.rectangle(image, coord[0][0], coord[-1][1], (255, 0, 0), 2)
